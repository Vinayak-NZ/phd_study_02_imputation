...
subset_vars <- c("ipaq_sit", "ipaq_walking", 
...
data_to_impute <-
  synthetic_data_missing[, names(synthetic_data_missing) %in% c("unique_id", input_variables)]
...
data_to_impute <-
  synthetic_data_missing[, names(synthetic_data_missing) %in% c("unique_id", missing_input_vars)]

data_remainder <- synthetic_data_missing[,!names(synthetic_data_missing) %in% missing_input_vars]
